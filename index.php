...
if (!empty($export)) {
    ...
    $head = [
        get_string('tcategories', 'report_coursesize'),
        get_string('tcourseid', 'report_coursesize'),
        get_string('tcourseshort', 'report_coursesize'),
        get_string('tcourse', 'report_coursesize'),
    ];
